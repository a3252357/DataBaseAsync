    ...
    public class LeaderDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SyncProgress>(entity =>
            {
                ...
                // 创建唯一索引：表名+从库服务器ID
                entity.HasIndex(e => new { e.TableName, e.FollowerServerId })
                      .IsUnique()
        ...
        public void CreateReplicationTriggers()
        {
            using (var connection = (MySqlConnection)Database.GetDbConnection())
            {
                ...
                foreach (var tableConfig in _tableConfigs.Where(t=>t.ReplicationDirection== ReplicationDirection.LeaderToFollower||t.ReplicationDirection== ReplicationDirection.Bidirectional))
                {
